<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($result === false) {
            ...
            $sql = "INSERT INTO college_details (cid, university, institution, state, district, address, programs, course, email, number, total_seats, reserved_seats, management_seats, about, certificate, status)
            VALUES ('$cid', '$university', '$institution', '$state', '$district', '$address', '$programs', '$selectedCourses', '$email', '$number', '$totalSeats', '$reserved', '$management', '$about', '$filename', 'unverfied')";
