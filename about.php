      ...
      <div class="row">
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              Welcome to myCollege, your ultimate resource for finding the perfect college or university that meets your unique educational goals and aspirations. We understand that choosing the right college can be a daunting task, and that's why we've created a user-friendly platform to simplify your search process.</p>       
            </div>
        </div>
        <div class="col-md-6 ">
          <div class="img-box">
